...
const T = computed(() => lang.value === 'en' ? {
  ...
  step2Sub2: '⚡ Advanced mode: Bring your own LLM (runs locally via OpenClaw, API key never leaves your machine). ×1.0 points, 60-120s polling.',
  ...
  step2Sub2: '⚡ 高效模式：自带 LLM（本地 OpenClaw 运行，API Key 不上传平台，完全安全），×1.0 满分积分，60-120 秒快速轮询。',
  step3Title: '邀请返佣',
