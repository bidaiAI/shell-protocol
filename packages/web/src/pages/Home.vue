...
const T = computed(() => lang.value === 'en' ? {
  ...
  s2Title: 'Craft Attack & Cross-Verify',
  s2Desc: 'Your miner receives a target agent profile. You use your own LLM to craft an attack payload, execute it locally, and submit for verification. 3 miners independently re-execute and vote (2/3 majority).',
  s2Highlight: 'Real hacker-grade challenge — 30-minute window per task, you craft and debug the attack yourself.',
  ...
  targetsDesc: '70 sandboxed AI agent profiles spanning DeFi, NFT, cross-chain, lending, payments, DAO, DevOps, AI engineering, autonomous agents, and 2026 trending platforms. Miners are assigned targets of varying difficulty.',
  ...
  step2Sub: '🆓 Free mode: Zero cost, ×0.2 points, platform generates payload.',
  step2Sub2: '⚡ Pro mode (v1.2.0): Bring your own LLM to craft attacks. 30-min window per task, ×1.0 full points. API key never leaves your machine.',
  ...
  s2Title: '构造攻击 & 多 Peer 验证',
  s2Desc: '矿机接收目标 Agent 画像，你用自己的 LLM 构造攻击词、本地执行、提交验证。3 名矿工独立重放相同 payload 并投票（2/3 多数共识）。',
  s2Highlight: '真正黑客级挑战 — 每个任务 30 分钟答题时间，攻击词需要自己构造和调试。',
  s3Title: '提交验证 & 赚取 $SHELL',
  s3Desc: '验证通过后自动发放 $SHELL 积分。矿机自动轮询验证进度（最长 120 秒），终端展示成功与否；段位越高倍率越高（最高 5x）。',
  targetsTitle: '目标 Agent 画像',
  targetsDesc: '70 个沙盒化 AI Agent 画像，覆盖 DeFi、NFT、跨链、借贷、支付、DAO、DevOps、AI 工程、自主代理及 2026 年流行平台等类别。矿工按难度分配目标。',
  ...
  step2Sub: '🆓 免费模式：零成本，×0.2 积分，平台 AI 生成 payload。',
  step2Sub2: '⚡ 高效模式（v1.2.0）：自带 LLM 构造攻击，30 分钟答题窗口，×1.0 满分积分。API Key 不上传平台，完全安全。',
  step3Title: '邀请返佣',
