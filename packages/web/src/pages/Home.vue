...
const T = computed(() => lang.value === 'en' ? {
  ...
  targetsDesc: '50 sandboxed AI agent profiles spanning DeFi, NFT, cross-chain, lending, payments, DAO, DevOps, AI engineering, and autonomous agent categories. Miners are assigned targets of varying difficulty.',
  ...
  targetsDesc: '50 个沙盒化 AI Agent 画像，覆盖 DeFi、NFT、跨链、借贷、支付、DAO、DevOps、AI 工程、自主代理等类别。矿工按难度分配目标。',
